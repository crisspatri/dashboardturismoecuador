...
// ############# TARTA ###################
	...
	function dsPieChart(){
		...
		d3.csv('https://raw.githubusercontent.com/crisspatri/dashboardturismoecuador/master/public/data/1.EntExt%20segun%20continente%20procedencia.csv', function(data) {
			...
			var refresh=d3.select("#idContinentes")				
			...
			function up1(d, i) {
				updateBarChart1(d.data.key, color(i));
			} 
...
// ############# BARRAS ###################
	...
	function updateBarChart1(anio, colorChosen) {
		...
		var plot = d3.select("#barChartPlot1")
